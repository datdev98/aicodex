describe('Arithmetic', function () {
    ...
    describe('Multiplication', function () {
        ...
        it('multiplies with negative exponent', function (done) {
            request.get('/arithmetic?operation=multiply&operand1=1.2e-5&operand2=1e5')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({result: 1.2});
                    done();
                });
        });
    });
    ...
    describe('Division', function () {
        ...
        it('divides an integer by a floating point number', function (done) {
            request.get('/arithmetic?operation=divide&operand1=2.5&operand2=0.5')
                .expect(200)
                .end(function (err, res) {
        ...
        it('divides with negative exponent', function (done) {
            request.get('/arithmetic?operation=divide&operand1=1.2e-5&operand2=1e-5')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({result: 1.2});
                    done();
        ...
        it('handles division by zero', function (done) {
